...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)-> ModelTrainerArtifact:
        try:
            ...
            transformed_trained_file_path= self.data_transformation_artifact.transformed_train_file_path
            ...
            housing_model= HousingEstimatorModel(preprocessing_object=preprocessing_object , trained_model_object= model_object)
