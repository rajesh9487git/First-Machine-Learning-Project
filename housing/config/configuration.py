...
class Configuration:
    ...
    def __init__(self, 
      ...
      try:
        self.conif_info= read_yaml_file(file_path=config_file_path)
    ...
    def get_data_ingestion_config(self)-> DataIngestionConfig:
        ...
        try:
            ...
            data_ingestion_info= self.conif_info[DATA_INGESTION_CONFIG_KEY]
    ...
    def get_data_validation_config(self)-> DataValidationConfig:
        try:
            ...
            data_validation_config= self.conif_info[data_validation_config]
