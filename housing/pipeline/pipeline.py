...
class Pipeline(Thread):
    ...
    def run_pipeline(self):
        try:
            ...
            model_trainer_artifact= self.start_model_trainer(data_transaformation_artifact=data_transaformation_artifact)     
        ...
        try:
            if Pipeline.experiment.experiment_id is not None:
                ...
                experiment_dict.update({
                    ...
                    "experiment_file_path": [os.path.basename(Pileline.experiment.experiment_file_path)]})
