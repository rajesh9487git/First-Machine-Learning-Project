...
class ModelFactory:
    ...
    def get_initialized_model_list(self)-> List[InitializedModelDetail]:
        ...
        try:
            ...
            for model_serial_number in self.models_initialization_config.keys():
                ...
                models_initialization_config= self.models_initialization_config[model_serial_number]
                model_obj_ref= ModelFactory.class_for_name(module_name= model_initialization_config[MODULE_KEY], 
                                                            class_name= models_initialization_config[CLASS_KEY])

                model = model_obj_ref()

                if PARAM_KEY in models_initialization_config:
                    model_obj_property_data= dict(models_initialization_config[PARAM_KEY])
                    model= ModelFactory.update_property_of_class(instance_ref=model, property_data=model_obj_property_data)

                param_grid_search= models_initialization_config[SEARCH_PARAM_GRID_KEY]
                model_name= f"{models_initialization_config[MODULE_KEY]}.{models_initialization_config[CLASS_KEY]}"
    ...
    @staticmethod
    def get_model_detail(model_details:List[InitiaizedModelDetail],
